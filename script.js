...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function handleOptionSelection(option) {
        ...
        switch (option) {
            case "Matricula 2024":
                chatMessages.innerHTML += `<p><strong>Praguinito:</strong> La matrícula está vigente del 15/01 al 02/02 de 2024 en nuestra plataforma <a href="https://cunanavalpraga.sieweb.com.pe/" target="_blank">SIEWEB</a></p>`;
                break;
            case "Aulas":
            ...
            case "Alimentación":
                ...
                break;
            case "Contáctanos":
                chatMessages.innerHTML += "<p><strong>Praguinito:</strong> Contamos con los siguientes canales de comunicación directa:<br>- Email: ieininojesusdepraga@ieinjp.edu.pe</p>";
                break;
        }
